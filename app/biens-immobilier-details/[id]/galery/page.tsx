...
import GalerieDropDown from "@/components/immobilier-details/galerie-drop-down";
import { MessageSquareMore } from "lucide-react";
import Image from "next/image";

export default function PageGaleryImmobilier() {
  return (
    <div className="llg:pr-18 lg:pb-16 max-w-7xl">
      ...
      <div className="lg:mt-20">
        ...
        <div className="lg:flex">
          <div className=" lg:w-[200px] sticky px-6">
            <h2 className="text-stone-700 font-bold text-[18px] md:text-[22px] lg:text-[30px]">Salon</h2>
          </div>
