        ...
        <div className="w-full select-none">
            ...
            >
                ...
                <CarouselContent className="-ml-4 pb-4">
                    {images.slice(0, 8).map((img, idx) => ( // J'ai augmenté slice à 8 pour plus de fluidité
                        <CarouselItem
                            key={idx}
                            // RESPONSIVE :
                        ...
                        >
                            <div className="group relative overflow-hidden rounded-xl bg-gray-100 border border-gray-200 shadow-sm transition-all hover:shadow-md">
