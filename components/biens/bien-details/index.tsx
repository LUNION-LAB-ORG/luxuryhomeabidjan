...
import {Bath, Bed, Building2, Calendar, Car, MapPin, Ruler, Share2, Warehouse,} from "lucide-react";
...
export default function BienDetails({slug}: { slug: string }) {
	...
	const MyMap = dynamic(() => import("@/components/common/map-field/my-map"), {
		ssr: false,
	...
	const SpecCard = ({icon: Icon, label, value, suffix = ""}: any) => (
		<div
			className="flex flex-col items-center justify-center p-6 bg-gray-50  border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all duration-300 group">
	...
	const message = `Bonjour ${property.agent?.fullname}, je suis intéressé(e) par le bien ${property.title}.`
			...
			<div className="container-8xl px-4 md:px-8 mx-auto py-8">
				...
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
					...
					<div className="lg:col-span-8 space-y-12">
						...
						{property.description && <section className="prose prose-lg max-w-none text-gray-600">
