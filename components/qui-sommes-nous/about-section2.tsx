...
export default function AboutSection2() {
  return (
    <section className="pb-10 ">
      ...
      <p className="text-zinc-600 my-6 leading-6 lg:leading-6">
            ...
            client au cœur de notre métier.<br/><br className="lg:hidden"/>À votre service, une équipe diversifiée internationale qui applique la
            ...
            notre conviction première est l'intérêt du client.<br/><br className="lg:hidden"/>  Chez Luxury Home Abidjan, une transaction immobilière
