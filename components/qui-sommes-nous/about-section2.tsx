	...
	return (
		<section className="pb-10">
			<div className="container mx-auto px-4 md:px-4 lg:px-16">
				<p className="text-zinc-600 my-6 leading-6 lg:leading-6 text-justify">
					<span className="font-semibold">Luxury Home Abidjan</span> est l'histoire d'un ensemble de collaborateurs qui ont une passion commune pour la
					...
					client au cœur de notre métier.<br/><br className="lg:hidden"/>À votre service, une équipe diversifiée
					internationale qui applique la
					...
					notre conviction première est l'intérêt du client.<br/><br className="lg:hidden"/> Chez Luxury Home Abidjan,
