              ...
              <div>
                <div className=" grid grid-cols-2 gap-6">
                  ...
                  <Input
                    placeholder="Votre nom"
                    className="border-gray-800 bg-black text-white placeholder:text-gray-500"
>>>>>>> f249766 (add retouche page deail)
                  />
          ...
          <div className="max-w-[550px] flex flex-col gap-6">
            ...
            <div className="flex gap-4 rounded-3xl h-fit border-2 p-6">
              ...
              <div>
                ...
                <p className=" text-md ">
                  Notre équipe vous garantit un accès permanent à toutes les
                  étapes clés de vos transactions immobilières.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 rounded-3xl h-fit border-2 p-6">
              ...
              <div>
                ...
                <p className=" text-md ">
                  Parce que la discrétion est la valeur essentielle au cœur de
                  notre métier, confiez nous en toute sérénité vos projets.{" "}
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 rounded-3xl h-fit border-2 p-6">
              ...
              <div>
                ...
                <p className=" text-md ">
                  Une équipe passionnée qui vous assure une prise en charge
                  immédiate et une relation clientèle privilégiée.
                </p>
              </div>
            </div>
