...
import {Bath, Bed, ChevronLeft, ChevronRight, MapPin, Ruler, X,} from "lucide-react";
import {
	Dialog,
	DialogContent,
	DialogDescription,
...
export default function Details({home}: { home: IBien }) {
			...
			<section className="py-10">
				<div className="flex flex-col md:flex-row justify-between items-center mb-6">
					<div className="px-6 md:px-12">
						...
						<div className="mt-2 inline-block bg-black text-white font-semibold px-4 py-1 rounded-full text-lg">
							{home.localisation}
						</div>
					</div>
				...
				<div className="mt-12 relative">
					<div className="px-6 md:px-12 flex justify-between items-center mb-6">
						...
						<Dialog open={open} onOpenChange={setOpen}>
							...
							<DialogContent
								className="max-w-5xl max-h-screen w-screen h-screen overflow-y-auto bg-white rounded-2xl p-6">
								<DialogHeader>
								...
								>
									<DialogContent
										className="w-screen  h-screen max-w-none p-0 bg-black flex items-center justify-center">
										{zoomImage && (
