  ...
  return (
    <div className="px-4 lg:px-14 mx-auto mt-26">
      <div className="max-w-lgg lg:max-w-full mx-auto  relative bg-gray-200 px-2 xl:py-2 rounded-[50px] xl:rounded-full flex flex-col xl:flex-row items-center xl:gap-16">
        {/* icon lhA */}
        <div className="absolute shadow-[50px] top-[-15%] xl:relative bg-gray-950 rounded-full shrink-0  w-[120px] h-[120px] p-6 lg:w-[210px] lg:h-[210px] lg:p-10">
          <Image
        ...
        <div className="w-full pb-10 pt-26 xl:pt-0 xl:py-0  llg:pt-12 px-4 flex flex-col flex-wrap lg:text-start ggap-6 lg:gap-4 text-[16px] lg:text-[14px]">
          <h1 className="w-fit mx-auto xl:mx-0 ppt-12 lg:pt-10 text-2xl sm:text-3xl ppl-4 lg:px-0  lg:text-[80px] font-bold bg-black  hover:bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
            Luxury Home Abidjan
          </h1>
